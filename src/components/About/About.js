        ...
        <div className="all-container">
          ...
          <div className="text-container">
            ...
            <p className="about-p">
              ...
              allows students to take the classes in any order they wish and at
              their own pace. In some schools you have a very strict schedule
              for taking the classes and this does not work into a lot of the
